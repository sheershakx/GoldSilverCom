...
public class date extends AppCompatActivity {
    ...
    public String[] conversion(int engYear,int engMonth, int engDay){
...
// decrement totalEngDaysCount until its value becomes 0
        ...
        String[] fulldate={Integer.toString(nepYear),Integer.toString(nepMonth),Integer.toString(nepDay)};
       return fulldate;
    }
